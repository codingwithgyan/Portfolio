            ...
            <Box className="card_box">
              ...
              >
                ...
                <Typography
                  ...
                  component="div"
                >
                  Epic Games is an online store for various types of games like
                  arcade, shooting, action ,etc.
                </Typography>
              ...
              <CardActions>
                <ButtonGroup className="btg_group">
                  <Button
                    ...
                    href="https://github.com/codingwithgyan/epic-clone"
                    variant="contained"
                  >
                    Github
                  </Button>
                  <Button
                    ...
                    className="btn_action"
                    sx={{ background: "#08090b" }}
                    href="https://epic-game-cw.herokuapp.com/"
                    variant="contained"
                  >
                    Website
                  </Button>
            ...
            <Box className="card_box">
              ...
              >
                ...
                <Typography
                  ...
                  component="div"
                >
                  A full-stack clone of Ecommerce website Strawberry-net
                  developed by 3 members in time span of 5 days. We have added
                  features like login/Signup, filter, sort , search products,
                  etc.
                </Typography>
                <Box className="svg_group">
                  <SvgIcon
              ...
              <CardActions>
                <ButtonGroup className="btg_group">
                  ...
                  <Button
                    ...
                    className="btn_action"
                    sx={{ background: "#08090b" }}
                    href="https://drive.google.com/file/d/1sDq9MwW1TpEMYxP3-7vjjwsdMa02pmDC/view?usp=sharing"
                    variant="contained"
                  >
                    Demo
                  </Button>
            ...
            <Box className="card_box">
              ...
              >
                ...
                <Typography
                  ...
                  component="div"
                >
                  A simple chat application built with socket.io. It enables
                  users to create a room and share the room id to whoever they
                  want the room to join.
                </Typography>
                <Box className="svg_group">
                  <SvgIcon
                    sx={{
              ...
              <CardActions>
                <ButtonGroup className="btg_group">
                  <Button
                    ...
                    className="btn_action"
                    sx={{ background: "#08090b" }}
                    href="https://github.com/codingwithgyan/chit-chat"
                    variant="contained"
                  >
                    Github
                  </Button>
                  <Button
                    ...
                    className="btn_action"
                    sx={{ background: "#08090b" }}
                    href="https://chit-chat-pro.herokuapp.com/"
                    variant="contained"
                  >
                    Website
                  </Button>
            ...
            <Box className="card_box">
              ...
              >
                ...
                <Typography
                  ...
                  component="div"
                >
                  A clone of Ecommerce website built with HTML, CSS and
                  Javascript only. We have added features like Admin panel, User
                  Panel, dynamic navbar, etc{" "}
                </Typography>
                <Box className="svg_group">
                  <SvgIcon
                    sx={{
              ...
              <CardActions>
                <ButtonGroup className="btg_group">
                  ...
                  <Button
                    ...
                    className="btn_action"
                    sx={{ background: "#08090b" }}
                    href="https://drive.google.com/file/d/1E15GyjSa8EKrC_EEXE-Q4MHoARnnTalb/view?usp=sharing"
                    variant="contained"
                  >
                    Demo
                  </Button>
